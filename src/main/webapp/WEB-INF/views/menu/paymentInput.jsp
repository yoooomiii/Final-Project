...
<body>
	<div id="Box">
		...
		<nav>
			<div class="logo">
				<a href="#"><span><img
						src="/Gold.html/img/logo1_ size60.png" alt=""></span></a>
			</div>
			<div class="menu">
				<ul>
					<li><a href="#"> HOME </a></li>
		...
		<section id="foodList">
			<div class="img">
				...
				<form action="payment_inputSave" method="post">
					...
					<br> 회원님의 ID <input type="text" value="${userid}" name="pm_id">
					<br>
					<br> 주문하신 금액 <input type="text" value="${i_price}" name="pm_price">
					<br>
					<br> 배달팁 <input type="text" value="2000" name="pm_tip">
					<br>
					<br> 총 결제금액 <input type="text" value="${i_price + 2000}" name="pm_total">
					<br>
					<br> 적립 포인트 <input type="text" value="${(i_price) * 0.05}" name="pm_point">
					<br>
					<br> 결제수단 선택 <select name="pm_pay">
					...
					<br>
					<br> 결제 정보 <input type="text" name="pm_card">
					<br>
					<br> 배달 주소 <input type="text" value="${useraddress}" name="pm_address">
					<br>
					<br> 수령 방법 <select name="pm_pick">
						<option value="">(선택안함)</option>
						<option value='배달주문'>배달주문</option>
						<option value='포장주문'>포장주문</option>
						</select>
					<br>
					<br> 요청 사항 <input type="text" value="요청없음" name="pm_comment">
					<br>
					<br>
					<br>
					<br>
