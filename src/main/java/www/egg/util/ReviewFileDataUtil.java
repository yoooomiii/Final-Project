...
public class ReviewFileDataUtil {
	...
	@Resource(name = "uploadPathss")  // 이름으로 주입받기, 그럼 이거 객체가 있어야 한다... 
	private String uploadPathss;

	public String getUploadPathss() {
		return uploadPathss;
	}

	public void setUploadPath(String uploadPathss) {
		this.uploadPathss = uploadPathss;
	}
